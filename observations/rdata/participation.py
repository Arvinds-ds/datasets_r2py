  ...
  *country* : Switzerland
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `participation.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/Participation.csv"
