...
def text_prices(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `text_prices.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/TextPrices.csv"
