...
def math_placement(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `math_placement.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/MathPlacement.csv"
