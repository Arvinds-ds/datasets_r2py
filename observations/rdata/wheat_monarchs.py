...
def wheat_monarchs(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `wheat_monarchs.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/Wheat.monarchs.csv"
