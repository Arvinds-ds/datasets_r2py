...
def weight_loss_incentive7(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `weight_loss_incentive7.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/WeightLossIncentive7.csv"
