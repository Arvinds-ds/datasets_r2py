...
def birthdeathrates(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `birthdeathrates.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HSAUR/birthdeathrates.csv"
