...
def immigration(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `immigration.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Zelig/immigration.csv"
    maybe_download_and_extract(path, url,
			       save_file_name="immigration.csv",
			       resume=False)
