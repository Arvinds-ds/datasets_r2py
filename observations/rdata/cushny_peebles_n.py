...
def cushny_peebles_n(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `cushny_peebles_n.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/CushnyPeeblesN.csv"
