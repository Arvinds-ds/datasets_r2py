...
def cushny_peebles(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `cushny_peebles.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/CushnyPeebles.csv"
