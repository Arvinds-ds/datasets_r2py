...
def public_schools(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `public_schools.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/sandwich/PublicSchools.csv"
