...
def us_classified_documents(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_classified_documents.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/USclassifiedDocuments.csv"
