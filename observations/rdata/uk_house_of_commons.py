...
def uk_house_of_commons(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `uk_house_of_commons.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/pscl/UKHouseOfCommons.csv"
