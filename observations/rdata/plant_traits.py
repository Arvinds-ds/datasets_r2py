...
def plant_traits(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `plant_traits.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/cluster/plantTraits.csv"
