...
def long_jump_olympics(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `long_jump_olympics.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/LongJumpOlympics.csv"
