...
def final_four_long(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `final_four_long.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/FinalFourLong.csv"
