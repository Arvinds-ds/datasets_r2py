...
def swim_records(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `swim_records.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/mosaicData/SwimRecords.csv"
