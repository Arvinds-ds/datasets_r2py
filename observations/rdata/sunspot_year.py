...
def sunspot_year(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `sunspot_year.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/sunspot.year.csv"
