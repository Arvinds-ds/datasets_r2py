...
def banking_crises(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `banking_crises.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/bankingCrises.csv"
