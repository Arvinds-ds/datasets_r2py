...
def ten_mile_race(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `ten_mile_race.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/mosaicData/TenMileRace.csv"
