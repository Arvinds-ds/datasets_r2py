...
def broken_marriage(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `broken_marriage.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/vcd/BrokenMarriage.csv"
