...
def political_information(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `political_information.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/pscl/politicalInformation.csv"
