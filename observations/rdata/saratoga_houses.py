...
def saratoga_houses(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `saratoga_houses.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/mosaicData/SaratogaHouses.csv"
