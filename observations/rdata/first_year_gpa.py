...
def first_year_gpa(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `first_year_gpa.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/FirstYearGPA.csv"
