...
def day1_survey(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `day1_survey.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/Day1Survey.csv"
