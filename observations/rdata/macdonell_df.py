...
def macdonell_df(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `macdonell_df.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/MacdonellDF.csv"
