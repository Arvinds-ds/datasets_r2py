...
def big9salary(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `big9salary.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/big9salary.csv"
