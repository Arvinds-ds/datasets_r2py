...
def orchard_sprays(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `orchard_sprays.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/OrchardSprays.csv"
