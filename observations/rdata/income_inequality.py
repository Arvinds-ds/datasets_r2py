...
def income_inequality(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `income_inequality.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/incomeInequality.csv"
