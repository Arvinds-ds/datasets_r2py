...
def beav1(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `beav1.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/MASS/beav1.csv"
    maybe_download_and_extract(path, url,
			       save_file_name="beav1.csv",
			       resume=False)
