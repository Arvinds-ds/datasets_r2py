...
def ambient_noxch(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `ambient_noxch.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/robustbase/ambientNOxCH.csv"
