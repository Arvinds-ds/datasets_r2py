...
def within_between(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `within_between.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/psych/withinBetween.csv"
