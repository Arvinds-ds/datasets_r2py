...
def rock_art(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `rock_art.csv`.
  Returns:
    Tuple of np.ndarray `x_train` with 103 rows and 641 columns and
    dictionary `metadata` of column headers (feature names).
  """
  path = os.path.expanduser(path)
  filename = "rock_art.csv"
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/DAAG/rockArt.csv"
