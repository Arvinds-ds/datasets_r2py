...
def cooling_water(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `cooling_water.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/mosaicData/CoolingWater.csv"
