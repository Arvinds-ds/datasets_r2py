...
def holzinger_9(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `holzinger_9.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/psych/Holzinger.9.csv"
