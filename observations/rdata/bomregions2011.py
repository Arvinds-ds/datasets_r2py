...
def bomregions2011(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `bomregions2011.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/DAAG/bomregions2011.csv"
