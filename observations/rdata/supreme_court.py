...
def supreme_court(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `supreme_court.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Zelig/SupremeCourt.csv"
