...
def snow_deaths(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `snow_deaths.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/Snow.deaths.csv"
