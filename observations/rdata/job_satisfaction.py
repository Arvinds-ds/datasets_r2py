...
def job_satisfaction(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `job_satisfaction.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/vcd/JobSatisfaction.csv"
