...
def french_fries(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `french_fries.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/reshape2/french_fries.csv"
