  ...
  *number of observations* : 20186
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `doctor_contacts.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/DoctorContacts.csv"
