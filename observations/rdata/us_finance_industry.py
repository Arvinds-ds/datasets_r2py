...
def us_finance_industry(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_finance_industry.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/USFinanceIndustry.csv"
