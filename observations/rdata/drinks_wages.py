...
def drinks_wages(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `drinks_wages.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/DrinksWages.csv"
