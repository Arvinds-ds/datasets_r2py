...
def hearing_test(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `hearing_test.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/HearingTest.csv"
