...
def humanpower1(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `humanpower1.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/DAAG/humanpower1.csv"
