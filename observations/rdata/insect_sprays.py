...
def insect_sprays(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `insect_sprays.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/InsectSprays.csv"
