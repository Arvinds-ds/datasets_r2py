...
def hair_eye_color(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `hair_eye_color.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/HairEyeColor.csv"
