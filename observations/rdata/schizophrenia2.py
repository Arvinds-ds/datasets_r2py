...
def schizophrenia2(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `schizophrenia2.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HSAUR/schizophrenia2.csv"
