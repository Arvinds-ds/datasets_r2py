...
def metro_health83(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `metro_health83.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/MetroHealth83.csv"
