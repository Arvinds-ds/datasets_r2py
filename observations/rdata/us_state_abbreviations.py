...
def us_state_abbreviations(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_state_abbreviations.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/USstateAbbreviations.csv"
