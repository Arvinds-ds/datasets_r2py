...
def minard_temp(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `minard_temp.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/Minard.temp.csv"
