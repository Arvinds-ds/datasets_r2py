...
def nkill_by_country_yr(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `nkill_by_country_yr.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/nkill.byCountryYr.csv"
