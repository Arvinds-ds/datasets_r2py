...
def cran_packages(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `cran_packages.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/CRANpackages.csv"
