...
def ucb_admissions(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `ucb_admissions.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/UCBAdmissions.csv"
