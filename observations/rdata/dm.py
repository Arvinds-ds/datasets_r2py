  ...
  *country* : Germany
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `dm.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/DM.csv"
    maybe_download_and_extract(path, url,
			       save_file_name="dm.csv",
			       resume=False)
