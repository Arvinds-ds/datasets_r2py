...
def presidential_elections(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `presidential_elections.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/pscl/presidentialElections.csv"
