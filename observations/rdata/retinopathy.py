...
def retinopathy(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `retinopathy.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/survival/retinopathy.csv"
