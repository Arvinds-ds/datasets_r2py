...
def plant_growth(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `plant_growth.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/PlantGrowth.csv"
