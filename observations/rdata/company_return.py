...
def company_return(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `company_return.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/wooldridge/return.csv"
