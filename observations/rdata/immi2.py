...
def immi2(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `immi2.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Zelig/immi2.csv"
    maybe_download_and_extract(path, url,
			       save_file_name="immi2.csv",
			       resume=False)
