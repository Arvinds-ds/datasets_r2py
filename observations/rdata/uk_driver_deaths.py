...
def uk_driver_deaths(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `uk_driver_deaths.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/UKDriverDeaths.csv"
