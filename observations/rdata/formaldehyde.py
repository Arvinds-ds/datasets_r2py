...
def formaldehyde(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `formaldehyde.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/Formaldehyde.csv"
