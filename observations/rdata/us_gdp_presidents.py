...
def us_gdp_presidents(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_gdp_presidents.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Ecdat/USGDPpresidents.csv"
