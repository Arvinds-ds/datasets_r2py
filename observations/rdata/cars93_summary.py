...
def cars93_summary(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `cars93_summary.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/DAAG/Cars93.summary.csv"
