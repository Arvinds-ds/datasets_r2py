...
def kostecki_dillon(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `kostecki_dillon.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/car/KosteckiDillon.csv"
