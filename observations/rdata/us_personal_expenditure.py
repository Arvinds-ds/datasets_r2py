...
def us_personal_expenditure(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_personal_expenditure.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/USPersonalExpenditure.csv"
