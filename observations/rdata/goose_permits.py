...
def goose_permits(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `goose_permits.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/mosaicData/GoosePermits.csv"
