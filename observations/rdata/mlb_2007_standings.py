...
def mlb_2007_standings(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `mlb_2007_standings.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/MLB2007Standings.csv"
