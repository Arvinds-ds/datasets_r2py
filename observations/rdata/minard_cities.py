...
def minard_cities(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `minard_cities.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/Minard.cities.csv"
