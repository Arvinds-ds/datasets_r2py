...
def johnson_johnson(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `johnson_johnson.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/JohnsonJohnson.csv"
