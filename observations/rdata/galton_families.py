...
def galton_families(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `galton_families.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/GaltonFamilies.csv"
