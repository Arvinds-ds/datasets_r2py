...
def religion_gdp(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `religion_gdp.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/ReligionGDP.csv"
