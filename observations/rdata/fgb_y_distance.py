...
def fgb_y_distance(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `fgb_y_distance.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/FGByDistance.csv"
