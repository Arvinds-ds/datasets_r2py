...
def infant_mortality(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `infant_mortality.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/Stat2Data/InfantMortality.csv"
