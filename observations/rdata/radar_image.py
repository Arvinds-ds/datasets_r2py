...
def radar_image(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `radar_image.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/robustbase/radarImage.csv"
