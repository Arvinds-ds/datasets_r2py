...
def australian_election_polling(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `australian_election_polling.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/pscl/AustralianElectionPolling.csv"
