...
def us_acc_deaths(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `us_acc_deaths.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/datasets/USAccDeaths.csv"
