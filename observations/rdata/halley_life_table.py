...
def halley_life_table(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `halley_life_table.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/HistData/HalleyLifeTable.csv"
