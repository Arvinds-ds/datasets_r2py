...
def epi_dictionary(path):
  ...
  Args:
    path: str.
      ...
      be downloaded and extracted there. Filename is `epi_dictionary.csv`.
  Returns:
  ...
  if not os.path.exists(os.path.join(path, filename)):
    url = "https://raw.github.com/vincentarelbundock/Rdatasets/master/csv/psych/epi.dictionary.csv"
